    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ url('/purchase/purchaseorder') }}" class="btn btn-secondary">Back</a>
            </div>
            <div class="card-body">
                <form id="save-purchaseorder-form" action="{{ route('purchase.purchaseorder.update', $requistion->id) }}" method="POST"
