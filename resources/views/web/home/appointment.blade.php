...
@section('content')
    ...
    <div class="appointment-page">
        ...
        <div class="col-12 text-center my-5">
            <a href="https://infinitewellnesspk.com/" class="image mb-7 mb-sm-10" data-turbo="false">
                <img alt="Logo" src="{{ $settingValue['app_logo']['value'] }}" style="max-width:40%" class=" logo-fix-size">
            </a>
        </div>

        <section class="appointment-section p-t-20 position-relative">
            <div class="container">
