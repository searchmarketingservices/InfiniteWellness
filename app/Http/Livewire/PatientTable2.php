...
class PatientTable2 extends LivewireTableComponent
{
    use WithPagination;
    ...
    public $buttonComponent = 'patients.add-button2';
    ...
    public function columns(): array
    {
            ...
            return [
                Column::make(__('messages.patients'), 'patientUser.first_name')->view('patients.columns.dietitan')
                    ->sortable()->searchable(),
