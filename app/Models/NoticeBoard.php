...
class NoticeBoard extends Model
{
    ...
    public function prepareNoticeboardData(): array
    {
        return [
            'id' => $this->id ?? 'N/A',
            'title' => $this->title ?? 'N/A',
            'description' => $this->description ?? 'N/A',
            'date' => isset($this->created_at) ? Carbon::parse($this->created_at)->format('d M, Y') : 'N/A',
            'time' => isset($this->created_at) ? \Carbon\Carbon::parse($this->created_at)->isoFormat('LT') : 'N/A',
        ];
    }
}
