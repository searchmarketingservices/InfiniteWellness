!(function (global, factory) {
                ...
                this.el
                  ...
                  .map(function (name) {
                    var _name$replace$split2 = _toArray(
                        name.replace(new RegExp("wire:"), "").split(".")
                      ),
          ...
          },
          {
            ...
            value: function (defaultDuration) {
              var durationInMilliSeconds,
                durationInMilliSecondsString = this.modifiers.find(function (
                  mod
                ) {
  ...
  function dispatch(eventName) {
    ...
    return (
      event.initEvent(eventName, !0, !0), document.dispatchEvent(event), event
    );
  }
   ...
   */ var isobject = function (val) {
    ...
    getValue = function (target, path, options) {
      ...
      const isArray = Array.isArray(path),
        ...
        joinChar =
          options.joinChar || ("string" == typeof splitChar ? splitChar : ".");
  ...
  var _default$6 = (function () {
    ...
    store$2 = {
      ...
      componentsListeningForEventThatAreTreeAncestors: function (el, event) {
        for (
          var parentIds = [], parent = el.parentElement.closest("[wire\\:id]");
          parent;
      ...
      rootComponentElementsWithNoParents: function () {
        ...
        var allEls = Array.from(node.querySelectorAll("[wire\\:initial-data]")),
          onlyChildEls = Array.from(
            node.querySelectorAll("[wire\\:initial-data] [wire\\:initial-data]")
          );
      ...
      setInputValue: function (el, value) {
        if (
          ...
          "SELECT" === el.tagName
            ...
            : ((value = void 0 === value ? "" : value), (el.value = value));
      },
  ...
  var inspectSource = sharedStore.inspectSource,
    ...
    shared = createCommonjsModule(function (module) {
      (module.exports = function (key, value) {
        return (
          sharedStore[key] || (sharedStore[key] = void 0 !== value ? value : {})
        );
      })("versions", []).push({
        version: "3.15.2",
        mode: "global",
  ...
  var internalState = {
    ...
    f$3 = descriptors
      ...
      : function (O, P) {
          if (
            ((O = toIndexedObject(O)), (P = toPrimitive(P, !0)), ie8DomDefine)
          )
            try {
    ...
    wellKnownSymbol = function (name) {
      return (
        (has$1(WellKnownSymbolsStore, name) &&
          (nativeSymbol || "string" == typeof WellKnownSymbolsStore[name])) ||
  ...
  var objectCreate =
    ...
    setToStringTag = function (it, TAG, STATIC) {
      it &&
        ...
        defineProperty$1(it, TO_STRING_TAG$3, { configurable: !0, value: TAG });
    },
    iterators = {},
          ...
          IteratorPrototype !== Object.prototype &&
            ...
            (objectGetPrototypeOf(CurrentIteratorPrototype) !==
              ...
              (objectSetPrototypeOf
                ...
                : "function" != typeof CurrentIteratorPrototype[ITERATOR$4] &&
                  createNonEnumerableProperty(
                    CurrentIteratorPrototype,
                    ITERATOR$4,
                    returnThis
      ...
      return (
        isArray(originalArray) &&
          ...
          (C !== Array && !isArray(C.prototype))
            ? isObject(C) && null === (C = C[SPECIES$3]) && (C = void 0)
            : (C = void 0)),
      ...
      return function ($this, callbackfn, that, specificCreate) {
        for (
          var value,
            ...
            boundFunction = functionBindContext(callbackfn, that, 3),
    ...
    objectAssign =
      ...
      fails(function () {
        ...
        return (
          ...
          7 != $assign({}, A)[symbol] ||
            "abcdefghijklmnopqrst" != objectKeys($assign({}, B)).join("")
        );
      })
      ...
      if (IS_ITERATOR) iterator = iterable;
        ...
        if (isArrayIteratorMethod(iterFn)) {
          for (
            ...
            if ((result = callFn(iterable[index])) && result instanceof Result)
              return result;
          return new Result(!1);
        }
  ...
  var microtask =
    ...
    notify = function (state, isReject) {
      if (!state.notified) {
        ...
        microtask(function () {
          for (
            var value = state.value, ok = state.state == FULFILLED, index = 0;
            chain.length > index;
        ...
        (this.bodyUsed = this.bodyUsed),
          ...
          body
            ? "string" == typeof body
              ...
              ? (this._bodyBlob = body)
              : support.formData && FormData.prototype.isPrototypeOf(body)
              ? (this._bodyFormData = body)
              : support.searchParams &&
                URLSearchParams.prototype.isPrototypeOf(body)
              ? (this._bodyText = body.toString())
              : support.arrayBuffer && support.blob && isDataView(body)
        ...
        _createClass(Connection, [
          ...
          },
          {
            ...
            value: function (response, message) {
              store$2.sessionHasExpiredCallback
                ? store$2.sessionHasExpiredCallback(response, message)
                : confirm(
          ...
          },
          {
            ...
            value: function (message) {
              ...
              fetch(
                ""
                  .concat(window.livewire_app_url, "/livewire/message/")
                ...
                .then(function (response) {
                  if (response.ok)
                    ...
                    if (
                      !1 === _this.onError(message, response.status, response)
                    )
                      return;
          ...
          attrNamespaceURI
            ? ((attrName = attr.localName || attrName),
              fromNode.getAttributeNS(attrNamespaceURI, attrName) !==
                attrValue &&
                ("xmlns" === attr.prefix && (attrName = attr.name),
          ...
          for (
            ...
            if (
              ...
              !(curChild = curChild.nextSibling) &&
                optgroup &&
                ((curChild = optgroup.nextSibling), (optgroup = null));
            }
        ...
        if ((callHook(onNodeAdded, el), !el.skipAddingChildren))
          for (var curChild = el.firstChild; curChild; ) {
            ...
            if (key) {
              ...
              unmatchedFromEl && compareNodeNames(curChild, unmatchedFromEl)
              ...
              outer: for (; curToNodeChild; ) {
                for (
                  ...
                  var curFromNodeType = curFromNodeChild.nodeType,
                    isCompatible = void 0;
                  if (
                    (curFromNodeType === curToNodeChild.nodeType &&
                      (curFromNodeType === ELEMENT_NODE
                        ? (curToNodeKey
                            ? curToNodeKey !== curFromNodeKey &&
                  ...
                  curFromNodeKey
                    ? addKeyedRemoval(curFromNodeKey)
                    : removeNode(curFromNodeChild, fromEl, !0),
                    (curFromNodeChild = fromNextSibling);
                }
                if (
                  curToNodeKey &&
    ...
    _default$1 = (function (_Action) {
      ...
      function _default(name, value, el) {
        ...
        return (
          ...
          (_this.name = name),
          (_this.payload = { id: _this.signature, name: name, value: value }),
          _this
        );
      }
      return _default;
                ...
                var _e$detail,
                  ...
                  value =
                    ...
                    void 0 === window.document.documentMode
                      ? null !== (_e$detail = e.detail) && void 0 !== _e$detail
                        ? _e$detail
                        : e.target.value
            ...
            /^((?!chrome|android).)*safari/i.test(navigator.userAgent) &&
              el.addEventListener("animationstart", function (e) {
                "livewireautofill" === e.animationName &&
                  ...
                  e.target.dispatchEvent(new Event("input", { bubbles: !0 })));
              });
        }
      },
          ...
          case "keyup":
            this.attachListener(el, directive, component, function (e) {
              ...
              if (
                ...
                selectedSystemKeyModifiers.filter(function (key) {
                  return (
                    ("cmd" !== key && "super" !== key) || (key = "meta"),
                    !e["".concat(key, "Key")]
                  );
                }).length > 0
              )
              ...
              return Boolean(
                0 === modifiers.length ||
                  (e.key && modifiers.includes(kebabCase(e.key)))
              );
            });
            break;
          case "click":
        ...
        directive.modifiers.includes("prefetch") &&
          el.addEventListener("mouseenter", function () {
            component.addPrefetchAction(
              new _default$4(directive.method, directive.params, el)
            );
          });
                  ...
                  "$emitUp" !== method
                    ? "$emitSelf" !== method
                      ? "$emitTo" !== method
                        ? directive.value &&
                          component.addAction(
                            new _default$4(method, params, el)
                          )
                      ...
                      : store$2.emitSelf.apply(
                          store$2,
                          [component.id].concat(_toConsumableArray(params))
                        )
                    : store$2.emitUp.apply(
                        store$2,
                        [el].concat(_toConsumableArray(params))
                      );
                });
            },
        ...
        var actions = message.updateQueue
          ...
          models = message.updateQueue
            ...
            .map(function (action) {
              ...
              return (
                modelActions.push(
                  name.split(".").reduce(function (fullAction, part) {
                    return (
                      modelActions.push(fullAction), fullAction + "." + part
                    );
                  })
                ),
                modelActions
    ...
    if (directives.get("target")) {
      ...
      actionNames =
        target.params.length > 0
          ? [generateSignatureFromMethodAndParams(target.method, target.params)]
        ...
        _createClass(UploadManager, [
          ...
          },
          {
            ...
            value: function (name, url) {
              ...
              Array.from(this.uploadBag.first(name).files).forEach(function (
                file
              ) {
                  ...
                  if ("2" !== (request.status + "")[0]) {
                    ...
                    422 === request.status && (errors = request.response),
                      _this2.component.call(
                        ...
                        name,
                        errors,
                        _this2.uploadBag.first(name).multiple
                      );
                  } else {
            ...
            Object.entries(component.unobservedData).forEach(function (_ref) {
              ...
              if (
                ...
                var livewireProperty = value.livewireEntangle,
                  ...
                  livewireComponent = livewireEl.__livewire,
                  livewirePropertyValue = livewireEl.__livewire.get(
                    livewireProperty
                  );
    ...
    return (
      _createClass(Component, [
        ...
        },
        {
          key: "childIds",
          get: function () {
            return Object.values(this.serverMemo.children).map(function (
              child
            ) {
              return child.id;
            });
          ...
          value: function () {
            ...
            (function countElementsBeforeMarker(el) {
              ...
              if (
                ...
                el.textContent.includes("wire-end:".concat(_this.id))
              )
                return carryCount;
        ...
        },
        {
          ...
          value: function (message) {
            var _this3 = this;
            Object.entries(message.response.serverMemo).forEach(function (
              _ref
            ) {
              var _ref2 = _slicedToArray(_ref, 2),
                key = _ref2[0],
              ...
              "data" === key
                ? Object.entries(value || {}).forEach(function (_ref3) {
                    ...
                    (_this3.serverMemo.data[dataKey] = dataValue),
                      message.shouldSkipWatcherForDataKey(dataKey) ||
                        Object.entries(_this3.watchers).forEach(function (
                          _ref5
                        ) {
                          ...
                          if (basePropertyName == dataKey) {
                            var potentiallyNestedValue = restOfPropertyName
                              ? getValue(dataValue, restOfPropertyName)
                              : dataValue;
        ...
        },
        {
          ...
          value: function (name, value) {
            ...
            defer
              ...
              : this.addAction(
                  new _default$4("$set", [name, value], this.el, skipWatcher)
                );
          }
        },
        {
          ...
          value: function (action) {
            if (action instanceof _default)
              ...
              if (
                ...
                var message = this.prefetchManager.getPrefetchMessageByAction(
                  action
                );
                return (
              ...
              message.replaying ||
                ...
                response.effects.emits &&
                  ...
                  response.effects.emits.forEach(function (event) {
                    ...
                    (_this6$scopedListener = _this6.scopedListeners).call.apply(
                      _this6$scopedListener,
                      [event.event].concat(_toConsumableArray(event.params))
                    ),
                      event.selfOnly
                        ? store$2.emitSelf.apply(
                            store$2,
                            [_this6.id, event.event].concat(
              ...
              morphdom(this.el, dom, {
                ...
                onBeforeNodeDiscarded: function (node) {
                  if (
                    ...
                    Array.from(node.attributes).some(function (attr) {
                ...
                onBeforeElUpdated: function (from, to) {
                  ...
                  store$2.callHook("element.updating", from, to, _this8),
                    from.hasAttribute("wire:model") &&
                      "SELECT" === from.tagName.toUpperCase() &&
                      (to.selectedIndex = -1);
                  ...
                  if (
                    ...
                    from.getAttribute("wire:id") !== _this8.id
                  )
                    return !1;
                ...
                onNodeAdded: function (node) {
                  if (
                    DOM.closestRoot(node).getAttribute("wire:id") === _this8.id
                  ) {
                    ...
                    DOM.isComponentRootEl(node) &&
                      (store$2.addComponent(
                        new Component(node, _this8.connection)
                      ),
            ...
            walk(this.el, function (el) {
              if (!el.isSameNode(_this9.el))
                return el.hasAttribute("wire:id")
                  ? (callbackWhenNewComponentIsEncountered(el), !1)
                    ...
                    if (
                      ...
                      return function () {
                        ...
                        return "emitSelf" === property
                          ? store$2.emitSelf.apply(
                              store$2,
                              [component.id].concat(args)
                            )
                          : "emitUp" === property
                          ? store$2.emitUp.apply(
                              store$2,
                              [component.el].concat(args)
                            )
                          : store$2[property].apply(store$2, args);
                      };
                    if (
                      [
                        "get",
        ...
        if ("input" === el.tagName.toLowerCase() && "file" === el.type) {
          var finish = function () {
              return el.dispatchEvent(
                new CustomEvent("livewire-upload-finish", { bubbles: !0 })
              );
            },
            error = function () {
              return el.dispatchEvent(
                new CustomEvent("livewire-upload-error", { bubbles: !0 })
              );
            },
            ...
            eventHandler = function (e) {
              0 !== e.target.files.length &&
                (el.dispatchEvent(
                  new CustomEvent("livewire-upload-start", { bubbles: !0 })
                ),
                e.target.multiple
        ...
        component.listeners.forEach(function (event) {
          if (event.startsWith("echo")) {
            ...
            ["channel", "private", "encryptedPrivate"].includes(channel_type)
              ...
              ? ["here", "joining", "leaving"].includes(event_name)
          ...
          el.addEventListener("input", function () {
            component.dirtyEls.forEach(function (dirtyEl) {
              ...
              ((directives.has("model") &&
                ...
                setDirtyState(
                  dirtyEl,
                  DOM.valueFromInput(el, component) != component.get(property)
                );
            });
          });
        }
    ...
    LivewireStateManager.clearState(),
        ...
        component.effects.path &&
          setTimeout(function () {
            var url = onlyChangeThePathAndQueryString(
                initializedPath ? void 0 : component.effects.path
              ),
              response = {
      ...
      store$2.registerHook("message.processed", function (message, component) {
        if (!message.replaying) {
          ...
          if (
            ...
            componentIdsThatAreWritingToHistoryState.has(component.id) &&
      ...
      store$2.registerHook("element.updated", function (node, component) {
        component.lastKnownDomId &&
          (node.getAttribute("wire:id") !== component.lastKnownDomId &&
            store$2.changeComponentId(component, node.getAttribute("wire:id")),
  ...
  var LivewireStateManager = {
      ...
      updateState: function (method, url, response, component) {
        ...
        store$2.callHook(
          "before" +
            ((subject = method).charAt(0).toUpperCase() + subject.slice(1)),
          fullstateObject,
          url,
          component
        );
      ...
      clearState: function () {
        window.history.state &&
          (window.history.state.livewire = new LivewireState().toStateArray());
      },
          ...
          },
          {
            ...
            value: function (signature, response, component) {
              ...
              var closestParentIndex = this.items.findIndex(function (item) {
                if (
                  _this.parseSignature(item.signature).originalComponentId ===
                  closestParentId
                )
                  return !0;
              });
          ...
          },
          {
            ...
            value: function (signature) {
              var _this$parseSignature2 = this.parseSignature(signature),
                ...
                sameNamedComponents = store$2.getComponentsByName(
                  componentName
                );
              return (
        ...
        for (
          response.effects.forStack.forEach(function (_ref) {
            ...
            if (
              startEl &&
              endEl &&
              !keyHasAlreadyBeenAddedToTheStack(startEl, endEl, key)
            ) {
              var frag = createFragment(contents);
              updates.push(function () {
                return "push" === type
                  ? ((el = frag), endEl.parentElement.insertBefore(el, endEl))
                  : (function (el) {
    ...
    return (
      _createClass(Livewire, [
        ...
        },
        {
          key: "all",
          value: function () {
            return Object.values(this.components.componentsById).map(function (
              component
            ) {
